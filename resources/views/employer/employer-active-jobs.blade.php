      ...
      <div class="col-sm-12 col-lg-4 col-xl-3 dn-smd">
        ...
        <div class="dashbord_nav_list">
          <ul>
            ...
            <li class="active"><a href="{{ url('/employer') }}/{{ $user->username }}/active-jobs"><span class="flaticon-paper-plane"></span> Active Jobs</a></li>
          ...
          <div class="col-lg-12 col-sm-12">
            <div class="cnddte_fvrt_job candidate_job_reivew style2">
              <div class="ui_kit_tab mt30">
                <div class="mbp_pagination">
                  <ul class="page_navigation">
                    ...
                    <li class="page-item active" aria-current="page">
                      <a class="page-link" href="{{ url('employer') }}/{{ $user->username }}/active-jobs/{{ $page }}">{{ $page }} 
                        <span class="sr-only">(current)</span>
                      </a>
                    </li>
                    @else
                    <li class="page-item"><a class="page-link" href="{{ url('employer') }}/{{ $user->username }}/active-jobs/{{ $page }}">{{ $page }}</a></li>
                    @endif
                    @endfor
                    <li class="page-item">
                ...
                <div class="table-responsive job_review_table job_active_table">
                  <table class="table">
                      ...
                      <tr>
                        <th scope="row">
                          ...
                          <ul>
                            ...
                            <li class="list-inline-item"><a class="color-black22" href="#">{{ date("F d, Y", strtotime($job->deadline)) }}</a></li>
                          </ul>
                        </th>
                        <td><span class="color-black22">{{ $job->count }}</span> Application(s)</td>
                        <td class="text-thm2">${{ $job->min_salary }} - {{ $job->max_salary }} (USD)</td>
                        <td>${{ Round($job->sum_salary/$job->count) }} (USD)</td>
                        <td>
                          <ul class="view_edit_delete_list" >
                            @if( sizeof($job->count) > 0 )
                            <li class="mt5">
                              <a href="{{ url('/employer') }}/{{ $user->username }}/job/{{ $job->id }}" data-toggle="tooltip" data-placement="bottom" title="View">
                              <span class="flaticon-eye"></span></a>
                            </li>
                            @endif
                            <li class="mt5"><a href="{{ url('/employer') }}/{{ $user->username }}/job/{{ $job->id }}/edit" data-toggle="tooltip" data-placement="bottom" title="Edit"><span class="flaticon-edit"></span></a></li>
                            <li class="mt5"><a href="#" data-toggle="tooltip" data-placement="bottom" title="Delete"><span class="flaticon-rubbish-bin"></span></a></li>
                          </ul>
                        </td>
                      </tr>
                    @endforeach
