        ...
        <div class="row">
          <div class="col-sm-12 col-lg-6">
            <div class="candidate_job_alart_btn">
              <h4 class="fz20 mb15">{{ sizeof($jobs) }} Jobs Found</h4>
          ...
          <div class="col-lg-12 mt30">
            <div class="fj_post style2">
              <div class="details">
                <h5 class="job_chedule text-thm">{{ $job->job_type }}</h5>
                <div class="thumb fn-smd">
                  <img class="img-thumbnail" width="100" src="{{ url('/') }}/{{ $emp_profile->avatar }}">
                </div>
                <h4>{{ $job->title }}</h4>
                <p>Posted {{ date("j F, Y") }} by <a class="text-thm" href="#">{{ $emp_profile->fullname }}</a></p>
                <ul class="featurej_post">
                  <li class="list-inline-item"><span class="flaticon-location-pin"></span> <a href="#">{{ $emp_state->name }}, {{ $emp_country->name }}</a></li>
                  <li class="list-inline-item"><span class="flaticon-price pl20"></span> <a href="#">${{ $job->min_salary }} - {{ $job->max_salary }} (USD)</a></li>
                </ul>
              </div>
              <a class="favorit" href="{{ url('/candidate') }}/{{ $user->username }}/job/show/{{ $job->id }}"><span class="flaticon-paper-plane"></span></a>
            </div>
          </div>
          @endforeach
        </div>
