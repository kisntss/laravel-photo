  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12 col-lg-4 col-xl-3 dn-smd">
        ...
        <div class="dashbord_nav_list">
          <ul>
            ...
            <li class="active"><a href="{{ url('/candidate') }}/{{ $user->username }}/completed-jobs"><span class="flaticon-favorites"></span> Completed Jobs</a></li>
      ...
      <div class="col-sm-12 col-lg-8 col-xl-9">
        <div class="row">
          <div class="col-lg-12">
            <h4 class="fz18 mb30">Completed Jobs</h4>
          </div>
          <div class="col-lg-12">
            <div class="mbp_pagination">
              <ul class="page_navigation">
                ...
                <a class="page-link" href="{{ url('candidate') }}/{{ $user->username }}/completed-jobs/{{ $page }}">{{ $page }} <span class="sr-only">(current)</span></a>
                </li>
                @else
                <a class="page-link" href="{{ url('candidate') }}/{{ $user->username }}/completed-jobs/{{ $page }}">{{ $page }}</a>
                @endif
                @endfor
                <li class="page-item">
              ...
              <div class="details">
                <div class="row">
                  ...
                  <div class="col-sm-8 col-lg-10">
                    <h5 class="job_chedule text-thm mt0">{{ $job->title }}</h5>
                    <h4>{{ $job->title }}</h4>
