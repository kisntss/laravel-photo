	...
	<header class="header-nav style_one dashboard_menu dashboard navbar-scrolltofixed main-menu">
      ...
      <nav>
        ...
        <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
          <li>
            <a href="{{ url('/candidate') }}/{{ $user->username }}/find-job"><span class="title">Find A Job</span></a>
          </li>
          <li>
            <a href="{{ url('/browse-employers') }}"><span class="title">Employers</span></a>
          </li>
          <li>
          ...
          <li>
            <a href="{{ url('candidate') }}/{{ $user->username }}/gallery">Gallery</a>
          </li>
        </ul>
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu">
                ...
                <div class="user_setting_content">
                  <a class="dropdown-item" href="{{ url('/candidate') }}/{{ $user->username }}/dashboard"><span class="flaticon-dashboard"></span> Dashboard</a>
                  <a class="dropdown-item" href="{{ url('/candidate') }}/{{ $user->username }}/profile"><span class="flaticon-profile"></span> Profile</a>
                  <a class="dropdown-item" href="{{ url('/candidate') }}/{{ $user->username }}/resume"><span class="flaticon-resume"></span> Resume</a>
                  <a class="dropdown-item" href="{{ url('/candidate') }}/{{ $user->username }}/applied-jobs"><span class="flaticon-paper-plane"></span> Applied Jobs</a>
                  <a class="dropdown-item" href="{{ url('/candidate') }}/{{ $user->username }}/completed-jobs"><span class="flaticon-favorites"></span> Completed Jobs</a>
                  <a class="dropdown-item" href="{{ url('/candidate') }}/{{ $user->username }}/messages"><span class="flaticon-chat"></span> Messages</a>
                  <a class="dropdown-item" href="{{ url('/candidate') }}/{{ $user->username }}/reviews"><span class="flaticon-rating"></span> Reviews</a>
                  <a class="dropdown-item" href="{{ url('/candidate') }}/{{ $user->username }}/recent-jobs"><span class="flaticon-alarm"></span> Recent Jobs</a>
                  <a class="dropdown-item" href="{{ url('/candidate') }}/{{ $user->username }}/change-password"><span class="flaticon-locked"></span> Change Password</a>
                  <a class="dropdown-item" href="{{ url('/candidate') }}/{{ $user->username }}/logout"><span class="flaticon-logout"></span> Logout</a>
                  <a class="dropdown-item" href="{{ url('/candidate') }}/{{ $user->username }}/delete-profile"><span class="flaticon-rubbish-bin"></span> Delete Profile</a>
                </div>
              </div>
            </div>
          </li>
